...
<body>
                ...
                <div class="panel-heading">
                 ...
                 <div class="panel-body">
                   <form method="POST">
                        ...
                        $cat_id = $_GET['cat_id'];
                        $sel = mysqli_query($con,"SELECT * from category where cat_id='$cat_id' and voided = 0");
    ...
    if(isset($_POST['submit'])){
      ...
      $cat_id = $_GET['cat_id'];
      $update = mysqli_query($con,"UPDATE category set category='$category' where cat_id='$cat_id' and voided = 0");
