         ...
         <div class="panel panel-success">
                <div class="panel-heading">
                 ...
                 $id = $_GET['post_Id'];
                  ...
                  $sql = "SELECT * FROM tblpost as tp join category as c on tp.cat_id=c.cat_id WHERE tp.post_Id='$id' and voided = 0";
                            ...
                            while($row=mysqli_fetch_array($run))
                            {
                             ...
                             if(isset($edit))
                             {
                                $sql = "UPDATE `tblpost` SET `title`='$title',`content`='$content',`category`='$category',`datetime`='$datetime' WHERE `post_Id`='$id' and voided = 0";
                               $run = mysqli_query($con,$sql);
